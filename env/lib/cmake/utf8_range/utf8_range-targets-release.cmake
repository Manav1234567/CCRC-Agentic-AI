...
set_target_properties(utf8_range::utf8_validity PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libutf8_validity.31.1.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libutf8_validity.31.1.0.dylib"
  )

list(APPEND _cmake_import_check_targets utf8_range::utf8_validity )
list(APPEND _cmake_import_check_files_for_utf8_range::utf8_validity "${_IMPORT_PREFIX}/lib/libutf8_validity.31.1.0.dylib" )
...
set_target_properties(utf8_range::utf8_range PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libutf8_range.31.1.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libutf8_range.31.1.0.dylib"
  )

list(APPEND _cmake_import_check_targets utf8_range::utf8_range )
list(APPEND _cmake_import_check_files_for_utf8_range::utf8_range "${_IMPORT_PREFIX}/lib/libutf8_range.31.1.0.dylib" )
