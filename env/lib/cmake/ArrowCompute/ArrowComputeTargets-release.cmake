...
set_target_properties(ArrowCompute::arrow_compute_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libarrow_compute.2200.0.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libarrow_compute.2200.dylib"
  )

list(APPEND _cmake_import_check_targets ArrowCompute::arrow_compute_shared )
list(APPEND _cmake_import_check_files_for_ArrowCompute::arrow_compute_shared "${_IMPORT_PREFIX}/lib/libarrow_compute.2200.0.0.dylib" )
